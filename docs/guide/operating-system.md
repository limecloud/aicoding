...
AI Coding 操作系统是一组稳定约束，而不是一组零散 Prompt。它要回答：AI 从哪里拿事实、如何拆任务、如何实现、如何自审、如何交付证据、人类在哪里介入。
